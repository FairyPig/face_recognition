...
def runLBP():
    ...
    m_recall = []
    m_x = []
    for n_components in range(3,320,2):
    #n_components = 150
        ...
        '''
        m_acc.append(f1_score(judgeType, y_pred, average='macro'))
        m_precision.append(precision_score(judgeType, y_pred, average='macro'))
        m_recall.append(recall_score(judgeType, y_pred, average='macro'))
    ...
    axarr[2].set_xlabel('PCA dimension')
